...
This project came out of learning and experimenting with API testing fundamentals using Postman and. I first ran this in the terminal using Newman with the exported collection. Finally, I built on this further by creating a Github Action workflow, leveraging Claude to write me the YAML code. 
